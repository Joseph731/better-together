...
const MULTIPLAYER_MENU_SCENE_PATH := "res://ui/multiplayer_menu/multiplayer_menu.tscn"
const INTERIOR_HOUSE_POSITION: Vector2 = Vector2(700, 100)

static var background_effects: Node2D
static var background_mask: Sprite2D

var player_scene: PackedScene = preload("uid://b0ulb6hlnqy22")
...
func _on_all_peers_ready():
	pass#lobby_manager.close_lobby()
	#enemy_manager.start()
